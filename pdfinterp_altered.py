...
class PDFPageInterpreter(object):
    ...
    def do_Tr(self, render):
        self.textstate.render = render#see textstate above
        return
    # settextrise
    def do_Ts(self, rise):
    ...
    def do_TJ(self, seq):
        ...
        if self.textstate.font is None:
            ...
            return       
        for2Mem=self.device.render_string(self.textstate, seq)
        return for2Mem
    # show
    def do_Tj(self, s):
        for2Mem=self.do_TJ([s])
        return for2Mem
    # quote
    def do__q(self, s):
        self.do_T_a()
    ...
    def process_page_to_mem(self, page):
        ...
        content+=self.render_contents(page.resources, page.contents, ctm=ctm)
